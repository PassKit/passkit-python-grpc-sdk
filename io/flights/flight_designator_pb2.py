...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'io.flights.flight_designator_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FLIGHTDESIGNATOR.fields_by_name['carrierCode']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['carrierCode']._serialized_options = b'\222A\022\212\001\017^[A-Z0-9]{3,4}$'
  _FLIGHTDESIGNATOR.fields_by_name['flightNumber']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['flightNumber']._serialized_options = b'\222A\002x\005'
  _FLIGHTDESIGNATOR.fields_by_name['active']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['active']._serialized_options = b'\222A\006:\004TRUE'
  _FLIGHTDESIGNATOR.fields_by_name['operatingCarrierCode']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['operatingCarrierCode']._serialized_options = b'\222A\005x\003\200\001\002'
  _FLIGHTDESIGNATOR.fields_by_name['operatingFlightNumber']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['operatingFlightNumber']._serialized_options = b'\222A\002x\005'
  _FLIGHTDESIGNATOR.fields_by_name['autoInvalidateAfter']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['autoInvalidateAfter']._serialized_options = b'\222A\006:\0042880'
  _FLIGHTDESIGNATOR.fields_by_name['autoInvalidateCancelledPasses']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['autoInvalidateCancelledPasses']._serialized_options = b'\030\001'
  _FLIGHTDESIGNATOR.fields_by_name['locationMessages']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['locationMessages']._serialized_options = b'\222A\003\240\001\n'
  _FLIGHTDESIGNATOR.fields_by_name['beaconMessages']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['beaconMessages']._serialized_options = b'\222A\003\240\001\n'
  _FLIGHTDESIGNATOR.fields_by_name['invalidateCancelledPasses']._options = None
  _FLIGHTDESIGNATOR.fields_by_name['invalidateCancelledPasses']._serialized_options = b'\222A\006:\004TRUE'
  _FLIGHTDESIGNATOR._options = None
  _FLIGHTDESIGNATOR._serialized_options = b'\222A\315\001\n\312\001*\021Flight Designator2ZA flight designator record describes mostly static data with regard to a flight operation.\322\001\013carrierCode\322\001\014flightNumber\322\001\006origin\322\001\010schedule\322\001\010revision\322\001\013destination\322\001\016passTemplateId'
  _FLIGHTDESIGNATORREQUEST.fields_by_name['carrierCode']._options = None
  _FLIGHTDESIGNATORREQUEST.fields_by_name['carrierCode']._serialized_options = b'\222A\005x\003\200\001\002'
  _FLIGHTDESIGNATORREQUEST.fields_by_name['flightNumber']._options = None
  _FLIGHTDESIGNATORREQUEST.fields_by_name['flightNumber']._serialized_options = b'\222A\002x\005'
  _FLIGHTDESIGNATORREQUEST._options = None
  _FLIGHTDESIGNATORREQUEST._serialized_options = b'\222Az\nx*\031Flight Designator Request2>Used for retrieving details of a particular flight designator.\322\001\013carrierCode\322\001\014flightNumber'
  _FLIGHTALERTS._serialized_start=2028
  _FLIGHTALERTS._serialized_end=2197
  _BOARDINGPOLICY._serialized_start=2199
  _BOARDINGPOLICY._serialized_end=2308
  _SEATCLASSPOLICY._serialized_start=2311
  _SEATCLASSPOLICY._serialized_end=2442
  _AUTHORITY._serialized_start=2444
  _AUTHORITY._serialized_end=2475
  _FLIGHTDESIGNATOR._serialized_start=178
  _FLIGHTDESIGNATOR._serialized_end=1334
  _FLIGHTDESIGNATORREQUEST._serialized_start=1337
  _FLIGHTDESIGNATORREQUEST._serialized_end=1567
  _FLIGHTSCHEDULE._serialized_start=1570
  _FLIGHTSCHEDULE._serialized_end=1860
  _FLIGHTTIMES._serialized_start=1863
  _FLIGHTTIMES._serialized_end=2025
