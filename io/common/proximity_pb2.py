...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'io.common.proximity_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\020com.passkit.grpcZ$stash.passkit.com/io/model/sdk/go/io\252\002\014PassKit.Grpc'
  _BEACON.fields_by_name['major']._options = None
  _BEACON.fields_by_name['major']._serialized_options = b'\222A\tY\000\000\000\000\340\377\357@'
  _BEACON.fields_by_name['minor']._options = None
  _BEACON.fields_by_name['minor']._serialized_options = b'\222A\tY\000\000\000\000\340\377\357@'
  _BEACON._options = None
  _BEACON._serialized_options = b'\222A\320\001\n\315\001*\006Beacon2\247\001A beacon record enables the pass to push a message to the lock screen when the user is in close proximity with the beacon. Beacons are currently only supported by iOS.\322\001\004uuid\322\001\021lockScreenMessage'
  _GPSLOCATION._options = None
  _GPSLOCATION._serialized_options = b'\222A\331\001\n\326\001*\014GPS Location2\244\001A location record enables the pass to be pushed to the lock screen when the user is in near the location. For iOS users, a customized message can also be displayed.\322\001\003lat\322\001\004long\322\001\021lockScreenMessage'
  _BEACON._serialized_start=112
  _BEACON._serialized_end=535
  _GPSLOCATION._serialized_start=538
  _GPSLOCATION._serialized_end=942
  _RELEVANTDATE._serialized_start=944
  _RELEVANTDATE._serialized_end=977
