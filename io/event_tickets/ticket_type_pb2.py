...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'io.event_tickets.ticket_type_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TICKETTYPE.fields_by_name['id']._options = None
  _TICKETTYPE.fields_by_name['id']._serialized_options = b'\222A\002@\001'
  _TICKETTYPE.fields_by_name['created']._options = None
  _TICKETTYPE.fields_by_name['created']._serialized_options = b'\222A\002@\001'
  _TICKETTYPE.fields_by_name['updated']._options = None
  _TICKETTYPE.fields_by_name['updated']._serialized_options = b'\222A\002@\001'
  _TICKETTYPE._options = None
  _TICKETTYPE._serialized_options = b'\222A\263\001\n\260\001*\013Ticket Type2nTicket Type holds details about the ticket type, and links to the before & after redeem Pass Template Designs.\322\001\014productionId\322\001\004name\322\001\032beforeRedeemPassTemplateId'
  _TICKETTYPELIMITEDFIELDS._options = None
  _TICKETTYPELIMITEDFIELDS._serialized_options = b'\222A\214\001\n\211\001*\027Ticket Type (Light ver)2nTicket Type holds details about the ticket type, and links to the before & after redeem Pass Template Designs.'
  _TICKETTYPE._serialized_start=189
  _TICKETTYPE._serialized_end=764
  _GETBYUIDREQUEST._serialized_start=766
  _GETBYUIDREQUEST._serialized_end=818
  _TICKETTYPELIMITEDFIELDS._serialized_start=821
  _TICKETTYPELIMITEDFIELDS._serialized_end=1032
  _TICKETTYPELISTREQUEST._serialized_start=1034
  _TICKETTYPELISTREQUEST._serialized_end=1109
