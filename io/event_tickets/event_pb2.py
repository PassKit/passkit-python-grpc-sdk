...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'io.event_tickets.event_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EVENT.fields_by_name['metrics']._options = None
  _EVENT.fields_by_name['metrics']._serialized_options = b'\222A\002@\001'
  _EVENT.fields_by_name['created']._options = None
  _EVENT.fields_by_name['created']._serialized_options = b'\222A\002@\001'
  _EVENT.fields_by_name['updated']._options = None
  _EVENT.fields_by_name['updated']._serialized_options = b'\222A\002@\001'
  _EVENT._options = None
  _EVENT._serialized_options = b'\222A\243\001\n\240\001*\005Event2vEvent is an instance of a Production; an event is showing; it holds the event start & end date/time and venue details.\322\001\nproduction\322\001\005venue\322\001\tstartDate'
  _EVENTLISTREQUEST._options = None
  _EVENTLISTREQUEST._serialized_options = b'\222AK\nI*\022Event List Request2&Used to list events in the production.\322\001\nproduction'
  _GETEVENTREQUEST._options = None
  _GETEVENTREQUEST._serialized_options = b'\222AY\nW*\021Get Event Request2!Used to retrieve an event record.\322\001\nproduction\322\001\005venue\322\001\tstartDate'
  _EVENTLIMITEDFIELDSRESPONSE._options = None
  _EVENTLIMITEDFIELDSRESPONSE._serialized_options = b'\222A\216\001\n\213\001*\021Event (Light ver)2vEvent is an instance of a Production; an event is showing; it holds the event start & end date/time and venue details.'
  _EVENTLIMITEDFIELDSREQUEST._options = None
  _EVENTLIMITEDFIELDSREQUEST._serialized_options = b'\222A\274\001\n\271\001*\021Event (Light ver)2vEvent is an instance of a Production; an event is showing; it holds the event start & end date/time and venue details.\322\001\014productionId\322\001\007venueId\322\001\022scheduledStartDate'
  _EVENTLISTRESPONSE._options = None
  _EVENTLISTRESPONSE._serialized_options = b'\222Ah\nf*\023Event List Response2OContains event search result. Production and venue objects have limited fields.'
  _EVENT._serialized_start=268
  _EVENT._serialized_end=959
  _EVENTLISTREQUEST._serialized_start=962
  _EVENTLISTREQUEST._serialized_end=1170
  _GETEVENTREQUEST._serialized_start=1173
  _GETEVENTREQUEST._serialized_end=1451
  _EVENTLIMITEDFIELDSRESPONSE._serialized_start=1454
  _EVENTLIMITEDFIELDSRESPONSE._serialized_end=1797
  _EVENTLIMITEDFIELDSREQUEST._serialized_start=1800
  _EVENTLIMITEDFIELDSREQUEST._serialized_end=2458
  _EVENTLISTRESPONSE._serialized_start=2461
  _EVENTLISTRESPONSE._serialized_end=3124
