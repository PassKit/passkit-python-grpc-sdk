...
# source: passkit/io/common/protocols.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'passkit/io/common/protocols.proto'
)
