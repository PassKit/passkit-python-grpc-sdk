...
# source: passkit/io/core/a_rpc_distribution.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'passkit/io/core/a_rpc_distribution.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DISTRIBUTION'].methods_by_name['addMessage']._loaded_options = None
  _globals['_DISTRIBUTION'].methods_by_name['addMessage']._serialized_options = b'\222A}\022\013Add message\032nRetrieves a list of fields used on the data collection page. ClassId is required only for the Member protocol.\202\323\344\223\002\032\"\025/distribution/message:\001*'
  _globals['_DISTRIBUTION'].methods_by_name['getMessage']._loaded_options = None
  _globals['_DISTRIBUTION'].methods_by_name['getMessage']._serialized_options = b'\222A#\022\013Get message\032\024Retrieves a message.\202\323\344\223\002\034\022\032/distribution/message/{id}'
  _globals['_DISTRIBUTION'].methods_by_name['getMessages']._loaded_options = None
  _globals['_DISTRIBUTION'].methods_by_name['getMessages']._serialized_options = b'\222A}\022\013Add message\032nRetrieves a list of fields used on the data collection page. ClassId is required only for the Member protocol.\202\323\344\223\002\030\022\026/distribution/messages'
  _globals['_DISTRIBUTION'].methods_by_name['updateMessage']._loaded_options = None
  _globals['_DISTRIBUTION'].methods_by_name['updateMessage']._serialized_options = b'\222A\200\001\022\016Update message\032nRetrieves a list of fields used on the data collection page. ClassId is required only for the Member protocol.\202\323\344\223\002\032\032\025/distribution/message:\001*'
  _globals['_DISTRIBUTION'].methods_by_name['cancelMessage']._loaded_options = None
  _globals['_DISTRIBUTION'].methods_by_name['cancelMessage']._serialized_options = b'\222A\200\001\022\016Cancel message\032nRetrieves a list of fields used on the data collection page. ClassId is required only for the Member protocol.\202\323\344\223\002\034*\032/distribution/message/{id}'
  _globals['_DISTRIBUTION']._serialized_start=267
  _globals['_DISTRIBUTION']._serialized_end=2946
